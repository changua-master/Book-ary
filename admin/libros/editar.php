...
if (!$book) {
    AuthMiddleware::setFlash('error', 'Libro no encontrado');
    header('Location: index.php');
    exit();
}
...
<head>
    ...
    <title>Editar Libro - <?php echo APP_NAME; ?></title>
            ...
            <div style="max-width: 900px; margin: 0 auto;">
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <p style="color: var(--color-secondary); margin: 0;">
                        Modificar información de: <strong><?php echo e($book['titulo']); ?></strong>
                    </p>
                </div>

                <!-- Formulario -->
                <form action="<?php echo url('admin/libros/actualizar.php'); ?>" method="POST" style="background: white; padding: 2rem; border-radius: 1rem; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    name="editorial" 
                                    class="form-input" 
                                    value="<?php echo e($book['editorial']); ?>"
                                >
                            </div>
                                ...
                                <select id="id_categoria" name="id_categoria" class="form-input" required>
                                    ...
                                    <?php while ($categoria = $categorias_result->fetch_assoc()): ?>
                                        <option value="<?php echo $categoria['id']; ?>" 
                                                <?php echo ($categoria['id'] == $book['id_categoria']) ? 'selected' : ''; ?>>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    class="form-input" 
                                    value="<?php echo $book['ano_publicacion']; ?>"
                                    min="1000" 
                                    max="<?php echo date('Y'); ?>"
                                >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    name="ejemplares" 
                                    class="form-input" 
                                    value="<?php echo $book['ejemplares']; ?>"
                                    min="0"
                                    required
                                >
                                <small style="color: var(--color-secondary); font-size: 0.85rem;">
                                    Actual: <?php echo $book['ejemplares']; ?>
                                </small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    name="ubicacion" 
                                    class="form-input" 
                                    value="<?php echo e($book['ubicacion']); ?>"
                                >
                            </div>
                        </div>
                    </div>
