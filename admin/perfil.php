            ...
            <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 2rem;">
                ...
                <div>
                    ...
                    <div class="card" style="text-align: center; padding: 2rem; margin-bottom: 2rem;">
                        <div style="width: 120px; height: 120px; margin: 0 auto 1.5rem; background: linear-gradient(135deg, var(--color-primary), var(--color-accent)); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 4rem; color: white; font-weight: bold; box-shadow: 0 8px 20px rgba(94,48,35,0.3);">
                            <?php echo $userInitial; ?>
                        </div>
                        ...
                        <div style="display: flex; gap: 0.5rem; justify-content: center;">
                            ...
                            <span class="badge" style="background: #673ab7; color: white;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1rem;">
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: #f8f9fa; border-radius: 0.5rem;">
                                <span style="color: var(--color-secondary);">
                                    <i class="fas fa-book"></i> Total de Libros
                                </span>
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: <?php echo $pendingRequests > 0 ? '#fff3cd' : '#f8f9fa'; ?>; border-radius: 0.5rem;">
                                <span style="color: var(--color-secondary);">
                                    <i class="fas fa-paper-plane"></i> Solicitudes Pendientes
                                </span>
                                <strong style="color: <?php echo $pendingRequests > 0 ? '#856404' : 'var(--color-primary)'; ?>; font-size: 1.2rem;">
                                    <?php echo $pendingRequests; ?>
                                </strong>
                            </div>
                            <?php if ($pendingRequests > 0): ?>
                                <a href="<?php echo url('admin/solicitudes/index.php'); ?>" class="btn btn-accent btn-sm" style="width: 100%;">
                ...
                <div>
                    ...
                    <div class="card" style="padding: 2rem; margin-bottom: 2rem;">
                        ...
                        <form action="<?php echo url('admin/actualizar-password.php'); ?>" method="POST" id="passwordForm">
                    ...
                    <div class="card" style="padding: 2rem;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1rem;">
                            <div style="padding: 1rem; background: #f8f9fa; border-radius: 0.5rem; border-left: 4px solid var(--color-accent);">
                            ...
                            <div style="padding: 1rem; background: #f8f9fa; border-radius: 0.5rem; border-left: 4px solid var(--color-accent);">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                                    <strong style="color: var(--color-primary);">
                                        <i class="fas fa-shield-alt"></i> Privilegios
                                    </strong>
                                </div>
                                <ul style="margin: 0.5rem 0 0 1.5rem; padding: 0; color: var(--color-secondary);">
                                    <li>Gestión completa de libros</li>
                            ...
                            <div style="padding: 1rem; background: #e7f3ff; border-radius: 0.5rem; border-left: 4px solid #2196F3;">
                                <strong style="color: #1565C0; display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
                                    <i class="fas fa-info-circle"></i> Accesos Rápidos
                                </strong>
                                <div style="display: flex; flex-direction: column; gap: 0.5rem; margin-top: 0.75rem;">
                                    <a href="<?php echo url('admin/dashboard.php'); ?>" style="color: #1976D2; text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
                                        <i class="fas fa-arrow-right"></i> Dashboard Principal
                                    </a>
                                    <a href="<?php echo url('admin/solicitudes/index.php'); ?>" style="color: #1976D2; text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
                                        <i class="fas fa-arrow-right"></i> Revisar Solicitudes
                                    </a>
                                    <a href="<?php echo url('admin/libros/index.php'); ?>" style="color: #1976D2; text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
                                        <i class="fas fa-arrow-right"></i> Gestionar Libros
                                    </a>
                                </div>
                            </div>
                        </div>
